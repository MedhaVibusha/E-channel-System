...
import doc from "../../assets/images/doctor-img03.png";
...
const Dashboard = () => {
  ...
  const [activePatientBooking, setActivePatientBooking] = useState(null);

  const handleSelectPatient = (booking) => {
    setActivePatientBooking(booking);
    setTab("patient-emr");
  };
          ...
          <div className="grid lg:grid-cols-3 gap-[30px] lg:gap-[50px]">
            ...
            <div className="lg:col-span-2">
              {data.isApproved === "pending" && (
                <div className="flex p-4 mb-4 text-yelllow-800 bg-yellow-50 rounded-lg">
                  <svg
                    aria-hidden="true"
